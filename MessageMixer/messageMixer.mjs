...
export const replaceAllOccurence = function(string, toBeReplaced, replaceWith) {
...
export const encode = function(string) {
    ...
    for (let key in replacementObject) {
        string = replaceAllOccurence(string, key, replacementObject[key]);
    }
    return string;
};
...
reverseAllWords, replaceFirstOccurence, replaceAllOccurence,encode, palindrome, pigLatin}
*/